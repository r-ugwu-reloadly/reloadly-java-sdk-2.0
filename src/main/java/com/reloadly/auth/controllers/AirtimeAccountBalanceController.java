 ...
 */
public final class AirtimeAccountBalanceController extends BaseController {
     ...
     */
    public AirtimeAccountBalanceController(Configuration config, HttpClient httpClient,
     ...
     */
    public DynamicResponse reloadlyAirtimeAccountBalance(
            final String accept,
            final String authorization) throws ApiException, IOException {
        HttpRequest request = buildReloadlyAirtimeAccountBalanceRequest(accept, authorization);
        HttpResponse response = getClientInstance().execute(request, false);
        HttpContext context = new HttpContext(request, response);

        return handleReloadlyAirtimeAccountBalanceResponse(context);
    }
     ...
     * @return    Returns the DynamicResponse response from the API call
     */
    public CompletableFuture<DynamicResponse> reloadlyAirtimeAccountBalanceAsync(
            final String accept,
            final String authorization) {
        return makeHttpCallAsync(() -> buildReloadlyAirtimeAccountBalanceRequest(accept,
                authorization),
            request -> getClientInstance().executeAsync(request, false),
            context -> handleReloadlyAirtimeAccountBalanceResponse(context));
    }

    /**
     * Builds the HttpRequest object for reloadlyAirtimeAccountBalance.
     */
    private HttpRequest buildReloadlyAirtimeAccountBalanceRequest(
            final String accept,
            final String authorization) {
    ...
    /**
     * Processes the response for reloadlyAirtimeAccountBalance.
     * @return An object of type DynamicResponse
     */
    private DynamicResponse handleReloadlyAirtimeAccountBalanceResponse(
